    ...
    <section className="bg-gray-50 py-16 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <p className="text-sm text-gray-400 mb-1">Our Process</p>
        ...
        <div className="relative">
          <div className="absolute top-8 left-[12.5%] right-[12.5%] h-0.5 bg-teal-200 z-0" />
          <div className="grid grid-cols-4 gap-6 relative z-10">
            {steps.map((step) => (
              <div key={step.title} className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-white border-2 border-teal-200 flex items-center justify-center mb-4 shadow-sm">
